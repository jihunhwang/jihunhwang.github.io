---
title: "TCP1P CTF 2023 Writeup"
date: 2023-10-16
description: TCP1P CTF 2023 Writeup
tags: ['CTF']
toc: true
mathjax: yes
...
<p><b><code>Flag: TCP1P{in_life's_abundance_a_fragment_suffices}</code></b></p>
</font>
...
<font size="4">
<p>
This challenge was pretty cute. You are given a PDF file of a love letter: <a href="/Downloads/chall.pdf"><code>chall.pdf</code></a>. You will soon realize that this letter is to sweet (?) for a CTF competition (I am obviously joking here, but hey, I'm sure you'd agree), something might have been hidden inside.
</p>
...
<img src="/image/tcp1p_2023/tcp1p_brokenimg_1.png">
...
<center>
<img src="/image/tcp1p_2023/o3VdrMpt.png">
</center>
<font size="4">
<p>Fortunately, there is an online tool that skews pictures <a href="https://www.luxa.org/image/tcp1p_2023/skew">https://www.luxa.org/image/tcp1p_2023/skew</a>. What a great world we live in today! Upon unskewing by skewing the skewed picture (pun intended a little bit), I got this:</p>
</font>
<center>
<img src="/image/tcp1p_2023/o3VdrMpt_unskewed.png">
</center>
<font size="4">
...
<ul>
<li><code>KZCU4UKNKZ BDOY2H KJWVQMTHG</code></li>
<li><code>BSGUTTGJZDD SUKNK5HDAZC YJF5FQMSK ONSFQSTGJZDTK22 YPJLG6TKXLI YGMULPHU======</code></li>
</ul>
...
<img src="/image/tcp1p_2023/tcp1p_brokenimg_flag.png">

<p>found the flag, as desired.</p> 

<p><b>Flag: <code>TCP1P{pdf_h4v3_4_P1ctur3_blur_4nd_5h1ft}</code></b></p>
