...
<font size="4">
<p> 
I played UIUCTF with b01lers this weekend. I was not planning on playing it initially because I had to finish up some research work and internship stuffs, but someone pinged me in the b01lers Discord server asking if I have any thoughts on this particular challenge.</p>
...
\end{align*}  
\]
<p>which is a very large number $n = 2887\dots5867$. Giving this number as input to the server works, but the problem is, we have to solve a discret log problem:</p>
{% highlight bash %}
...
<font size="4">
  <p>This writeup apparently was <a href="https://sigpwny.com/events/uiuctf/2024/">selected</a> as one of the best writeups for this challenge by SIGPwny. Thank you again, SIGPwny! </p>
</font>
...
<font size="4">
  ...
  <p>As always, attention to detail is key.</p>
</font>
