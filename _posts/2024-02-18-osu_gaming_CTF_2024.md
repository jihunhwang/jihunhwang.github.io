...
<p>All we need to do is to automate this process. There isn't much things I had to do, other than the fact that I needed a rookie reminder that variables in Python are references to objects in memory (I wasted an hour on that).
</p>
</font>
