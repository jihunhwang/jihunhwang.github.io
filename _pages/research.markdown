...
<font size="4">
<p>
Fresh out of undergraduate, I have to confess that my research interest is a bit 'all over the place' and still smoothly (hence continuously) permuting. My interest can be summarized as "<b>Solving physics/computer science problems from mathematical standpoints</b>".
</p>
<p>
I am interested in studying differential geometry, mainly in <b>geometric analysis</b> (<a href="https://www.youtube.com/watch?v=ILba39ad36k">geometric flows</a>, <a href="https://www.youtube.com/watch?v=gvLBbh0VKXw">minimal and constant-mean-curvature (CMC) surfaces</a>, etc.), and its directly derived fields such as general relativity and integrable systems.
</p>
<p>
